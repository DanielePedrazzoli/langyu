...
class DetailsPanelNotes extends StatelessWidget {
  final WordMeaning meaning;
  const DetailsPanelNotes({super.key, required this.meaning});
  ...
  Widget build(BuildContext context) {
    ...
    return Card.filled(
      ...
      child: ExpansionTile(
        ...
        title: Text("Notes"),
        children: [Text("Note1"), Text("Note2"), Text("Note3"), Text("Note4")],
      ),
    );
  }
}
